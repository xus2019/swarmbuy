...
public class MiaoshaUserExample {
    ...
    public MiaoshaUserExample limit(Integer rows) {
        this.rows = rows;
        return this;
    }

    public MiaoshaUserExample limit(Integer offset, Integer rows) {
        this.offset = offset;
        this.rows = rows;
        return this;
    }

    public MiaoshaUserExample page(Integer page, Integer pageSize) {
