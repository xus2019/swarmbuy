...
public class MiaoshaGoodsExample {
    ...
    public MiaoshaGoodsExample limit(Integer rows) {
        this.rows = rows;
        return this;
    }

    public MiaoshaGoodsExample limit(Integer offset, Integer rows) {
        this.offset = offset;
        this.rows = rows;
        return this;
    }

    public MiaoshaGoodsExample page(Integer page, Integer pageSize) {
